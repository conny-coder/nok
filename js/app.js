(() => {
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".images-banner__slider")) new core(".images-banner__slider", {
            ...
            if (document.querySelector(".delivery__slider")) new core(".delivery__slider", {
        ...
        class ScrollWatcher {
            ...
            scrollWatcherIntersecting(entry, targetElement) {
                if (entry.isIntersecting) {
                    if (targetElement.classList.contains("partnership")) document.querySelector(".menu__link_partner").classList.add("_navigator-active");
                    !targetElement.classList.contains("_watcher-view") ? targetElement.classList.add("_watcher-view") : null;
                    this.scrollWatcherLogging(`Я вижу ${targetElement.classList}, добавил класс _watcher-view`);
                } else {
                    if (targetElement.classList.contains("partnership")) document.querySelector(".menu__link_partner").classList.remove("_navigator-active");
